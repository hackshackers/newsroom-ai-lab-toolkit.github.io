...
Before we start exploring slotion ideas or evaluating possible tools we need to get super on **what problem actually needs solving**, **who it impacts** and **what specific value a solution would provide*.
*.
...
- **<span className="highlight-user">User</span>**: *Who* is affected? (Reporter, editor, another specific role, a specific desk or team, the whole newsroom?)
