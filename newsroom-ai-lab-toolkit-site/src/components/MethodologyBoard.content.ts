...
export const STEP_DETAILS: StepDetail[] = [
  // Step 1 — Talk to people
  {
    ...
    summary:
      "Like backgrounding a story: notice pain points, talk to people, map sources, gather clues and hunches. No filtering yet — you're building a sense of what's happening before you know the central question.",
    outcome:
    ...
    whyItMatters:
      'People will tell you what they need if you\'re not already selling them something. Solutioning too early narrows what you\'re willing to hear. This step only works if you stay genuinely curious about the problem, not the fix.',
  },
  ...
  // Step 7 — Define requirements
  {
    ...
    summary:
      'Before drafting, automating, or prototyping anything, pause to define the work clearly enough that a human can judge whether the result is useful, accurate, and safe to use. This step turns a promising idea into something testable.',
    outcome:
    ...
    whyItMatters:
      'Without requirements, you can\'t tell if your prototype worked. This step is the difference between "seems good" and actually knowing.',
  },
